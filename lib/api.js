...
var Server = function() {
    ...
    httpSrv.get('/api/host(/[\\w\\.]+)?/?', function(req, res) {
    ...
    httpSrv.put('/api/host/?', function(req, res) {
        ...
        form.parse(req, function(err, fields, files) {
            ...
            cfg.setHostIPMapping(fields.host, ips);
    ...
    httpSrv.del('/api/host(/[\\w\\.]+)?/?', function(req, res) {
        var host = (req.params[0]) ?
            req.params[0].substring(1, req.params[0].length) :
            undefined;
